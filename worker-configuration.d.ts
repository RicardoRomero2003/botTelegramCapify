/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: bb2c959e1baba632b64ec4084ba4f2ff)
...
declare namespace Cloudflare {
	...
	interface Env {
		CAPIFY_BOT_SESSIONS: KVNamespace;
		TELEGRAM_BOT_TOKEN: string;
		TELEGRAM_ALLOWED_CHAT_IDS: string;
		SUPABASE_URL: string;
		SUPABASE_ANON_KEY: string;
		SUPABASE_SERVICE_ROLE_KEY: string;
		CAPIFY_API_BASE_URL: string;
		BOT_SESSION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_BOT_TOKEN" | "TELEGRAM_ALLOWED_CHAT_IDS" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "CAPIFY_API_BASE_URL" | "BOT_SESSION_SECRET" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
